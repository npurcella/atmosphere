...
def _ensure_user_allocation_source(user):
    ...
    try:
        ...
        logger.debug(
            'No AllocationSource with name %s found. Creating a new AllocationSource.',
        ...
        logger.debug(
            'AllocationSource with name %s exists. Skipping creation step.',
            allocation_source_name
        )
    try:
        ...
        logger.debug(
            'No UserAllocationSource with name %s found. Assigning allocation source to user.',
            allocation_source_name
        )
        _assign_user_allocation_source(allocation_source, user)
    else:
        logger.debug(
            'UserAllocationSource with name %s exists: %s Skipping creation step.',
